...
class SparkApplicationRequest:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.restart_policy.on_failure_retry_interval:
            restart_policy_dict["onFailureRetryInterval"] = self.restart_policy.on_failure_retry_interval
        if self.restart_policy.on_submission_failure_retries is not None:
            restart_policy_dict["onSubmissionFailureRetries"] = self.restart_policy.on_submission_failure_retries
        if self.restart_policy.on_submission_failure_retry_interval:
            restart_policy_dict["onSubmissionFailureRetryInterval"] = self.restart_policy.on_submission_failure_retry_interval
        ...
        if self.dynamic_allocation and self.dynamic_allocation.enabled:
            ...
            if self.dynamic_allocation.shuffle_tracking_enabled is not None:
                dyn_alloc["shuffleTrackingEnabled"] = self.dynamic_allocation.shuffle_tracking_enabled
            if self.dynamic_allocation.shuffle_tracking_timeout is not None:
                dyn_alloc["shuffleTrackingTimeout"] = self.dynamic_allocation.shuffle_tracking_timeout
...
class ApplicationStatus:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ApplicationStatus':
        ...
        return cls(
            submission_id=data.get('submissionId', data.get('submission_id', data.get('metadata', {}).get('name', ''))),
            app_id=app_id,
